...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(0), 20, PRSC_DIV_SEL_16, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_32                                  \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(1), 20, PRSC_DIV_SEL_16, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_32                                  \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(2), 20, PRSC_DIV_SEL_16, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_32                                  \
	}
